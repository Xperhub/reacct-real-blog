    ...
    <div name= "pricing" className='w-full text-white my-24'>
        ...
        <div className='max-w-[1240px] mx-auto py-12'>
            <div className='text-center py-8 text-slate-300'>
                ...
                <h3 className='text-5xl font-bold text-white py-8'> This right price for tour research</h3>
                <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Non impedit culpa deserunt reprehenderit velit quisquam alias consequuntur hic, ipsum, a blanditiis incidunt ut! Molestias quibusdam fugit non quia, consequuntur dolores!</p>
            </div>
            ...
            <div className='grid md:grid-cols-2'>
                ...
                <p className='text-2xl py-8 text-slate-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, odit?</p>
